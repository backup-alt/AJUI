...
const adminCreateEmployeeInviteSchema = z.object({
  ...
  // projectIds is optional — admin can invite a PM/accountant without
  // selecting projects. The PM/accountant can be assigned to projects
  // later from the employee detail page. If no projects are assigned,
  // they simply see no projects in their scope.
  projectIds: z
