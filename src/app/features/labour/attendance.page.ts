    ...
    <ion-content class="attendance-content">
      ...
      <div class="today-bar">
        ...
        <div class="today-count" [class.has-count]="totalMarkedToday() > 0">
          ...
          <span class="count-label">{{ totalMarkedToday() === 1 ? 'sub marked' : 'subs marked' }}</span>
        </div>
      </div>
      ...
      <ion-fab slot="fixed" vertical="bottom" horizontal="end">
        <ion-fab-button (click)="addSubcontractor()">
...
export class AttendancePage implements OnInit, OnDestroy {
  ...
  addSubcontractor(): void {
    this.router.navigate(['/tabs/labour/add-subcontractor']);
  }
}
