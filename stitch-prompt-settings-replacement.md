# Settings Page Restructure — Stitch Prompt Replacement

## Summary
Replace the existing section `[14] 14-settings.html` in the main Stitch prompt
with the new Windows 11-style settings layout described below. The new
settings page is a two-pane layout (left nav + right detail) with these
sub-pages:

1. Account (unchanged)
2. Notifications (unchanged)
3. **Appearance (NEW)** — Theme settings
4. **Roles and Employees (NEW)** — Employee list + permissions
5. **Sites Directory (MOVED from /sites)** — Neat card grid
6. **Supervisors Directory (MOVED from /supervisors)**
7. Approval Rules (unchanged)
8. **Access Schedule (NEW)** — Untimed management
9. Devices, Sessions, Reports, Privacy, About (unchanged)

---

## Drop-in Replacement for the Existing `[14] 14-settings.html` Section
...
## [14c] Appearance Sub-page (NEW — THEME SETTINGS)

```
=================================================================
[14c] 14c-appearance.html — THEME SETTINGS
=================================================================
...
## [14d] Roles and Employees Sub-page (NEW)

```
=================================================================
[14d] 14d-roles.html — ROLES AND EMPLOYEES
=================================================================
Purpose: Manage which employees (admins, project managers, accountants)
exist in the system, and configure what each role can approve/decline
...
Layout (right pane):
  ...
  - Invite Employee modal:
    ...
    - "Send Invite" button
    - On submit: POST /settings/employees/invite → success modal
...
## [14e] Sites Directory Sub-page (MOVED from /sites)

```
=================================================================
[14e] 14e-sites.html — SITES DIRECTORY
=================================================================
...
## [14f] Supervisors Directory Sub-page (MOVED from /supervisors)

```
=================================================================
[14f] 14f-supervisors.html — SUPERVISORS DIRECTORY
=================================================================
Same as /supervisors page but in the settings layout.
Layout: Table with Supervisor ID, Name, Phone, Email, Assigned Project,
Cash Limit, Approval Authority, Status.
Click row → drawer with profile + assigned projects + last 10 submissions.
```

---

## [14h] Access Schedule Sub-page (NEW — UNTIMED MANAGEMENT)

```
=================================================================
[14h] 14h-access-schedule.html — ACCESS SCHEDULE (UNTIMED MANAGEMENT)
=================================================================
...
## [14i] Other Settings Sub-pages

```
=================================================================
[14i] Other Sub-pages (Devices, Sessions, Reports, Privacy, About)
=================================================================
